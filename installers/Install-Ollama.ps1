...
$step1 = if ($isUk) { "▶ Перевірка Ollama в системі..." } else { "▶ Checking Ollama in system..." }
...
$step2 = if ($isUk) { "`n▶ Аналіз конфігурації комп'ютера..." } else { "`n▶ Analyzing system hardware configuration..." }
